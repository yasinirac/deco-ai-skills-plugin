---
name: grill-me
description: Interview the user relentlessly about a plan or design until reaching shared understanding, resolving each branch of the decision tree. Use when user wants to stress-test a plan, get grilled on their design, challenge an approach, or mentions "grill me". Use for general plans, designs, and proposals where no domain glossary or codebase exists yet. **For grilling that uses an existing codebase or product-context.md, use grill-with-docs instead.**
---
